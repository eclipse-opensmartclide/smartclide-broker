...
@RestController
@RequestMapping(path = "broker/api/v1/consumer/serviceDiscovery")
public class ServiceDiscoveryConsumer {
...
//            msg = (ServiceCreationMessage) template.receiveAndConvert(ServiceCreationMessagingConfig.SERVICE_DISCOVERY_QUEUE);
//        }
