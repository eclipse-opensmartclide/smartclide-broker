...
@RestController
@RequestMapping(path = "broker/api/v1/consumer/smartAssistant")
...
//            msg = (ServiceCreationMessage) template.receiveAndConvert(ServiceCreationMessagingConfig.SMART_ASSISTANT_QUEUE);
//        }
